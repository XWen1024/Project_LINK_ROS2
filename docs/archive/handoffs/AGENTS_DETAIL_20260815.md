...
- The durable Navigation2 handoff is `docs/modules/navigation/HANDOFF.md`. Keep it
...
- ESP32-C3 + VL53L0X bench bridge: native USB Serial/JTAG 303a:1001, I2C on
  ...
  docs/modules/sensors/vl53l0x/HANDOFF.md; Orin build and mounted-sensor field
...
- Durable handoff: `docs/modules/uwb/HANDOFF.md`.
...
- The fastest site runbook is `docs/runbooks/SITE_VOICE_MOBILE_MANIPULATION.md`.
...
- The module must not publish `/cmd_vel`, start Nav2, control SO-101, or replace
  ...
  `docs/modules/sensors/fall-response/VOICE_INTEGRATION.md` before changing the audio contract.
...
- During Windows calibration, disable normal connection, torque, gripper,
  ...
  `docs/modules/manipulation/WINDOWS_LAB.md`.
