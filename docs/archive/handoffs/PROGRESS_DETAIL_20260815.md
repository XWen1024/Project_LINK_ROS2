...
* Added docs/modules/sensors/vl53l0x/HANDOFF.md with the serial protocol,
...
* Added `docs/modules/uwb/HANDOFF.md` with protocol, build, calibration,
...
* Removed the redundant caller-facing `source_id` from the Action Goal after
...
* Extracted the current Point-LIO/slam_toolbox/Nav2 architecture, verified
  ...
  safety rules, and endurance TODO into `docs/modules/navigation/HANDOFF.md`.
* Added `docs/modules/navigation/COMMANDS.md` as a command-only quick reference with
...
* Added site bringup helpers for the fastest field path:
  ...
  * `docs/runbooks/SITE_VOICE_MOBILE_MANIPULATION.md` documents the map,
...
* Added `docs/modules/sensors/fall-response/VOICE_INTEGRATION.md` for the audio project:
