...
PARAMETERS = [
    ...
    ("qwen", "turn_detection_threshold", "服务端 VAD 阈值", "", 0.0, 1.0, 0.05, True),
    ("qwen", "turn_detection_silence_duration_ms", "服务端 VAD 静音", "ms", 100, 5000, 100, True),
    ...
    ("qwen", "listen_during_wakeup_ack", "唤醒回复播放时同时监听", "", False, True, None, False),
    ("qwen", "local_audio_peak_threshold", "本地有声峰值阈值", "", 100, 10000, 100, False),
    ("qwen", "local_audio_rms_threshold", "本地有声 RMS 阈值", "", 10.0, 5000.0, 10.0, False),
    ("qwen", "local_audio_min_voiced_chunks", "兜底提交最少有声分块", "", 1, 100, 1, False),
...
PARAMETER_DEFAULTS = {
    ...
    ("qwen", "turn_detection_threshold"): 0.3,
    ("qwen", "turn_detection_silence_duration_ms"): 1000,
    ...
    ("qwen", "first_turn_no_speech_timeout_sec"): 12.0,
    ("qwen", "listen_during_wakeup_ack"): False,
    ("qwen", "local_audio_peak_threshold"): 700,
    ("qwen", "local_audio_rms_threshold"): 120.0,
    ("qwen", "local_audio_min_voiced_chunks"): 3,
